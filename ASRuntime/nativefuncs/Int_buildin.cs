            ...
            else
            {
                ...
                else
                {
                    ...
                    return 
                        ...
                        ((rtInt)thisObj.value.memberData[0].getValue()).value.ToString("g" + (r))
            ...
            else
            {
                ...
                else
                {
                    ...
                    return
                        ...
                        ((rtInt)thisObj.value.memberData[0].getValue()).value.ToString("e" + (r+1))
            ...
            else
            {
                ...
                else
                {
                    ...
                    return
                        ...
                        ((rtInt)thisObj.value.memberData[0].getValue()).value.ToString("f" + (r))
        ...
        public override IRunTimeValue execute(rtObject thisObj, ISLOT[] argements, out string errormessage, out int errorno)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var toCast = ((rtInt)thisObj.value.memberData[0].getValue()).value;
