...
namespace ASBinCode
{
	...
	//public sealed class MemRegister_Object : LeftValueBase, IMemReg
	//{

	//	public MemRegister_Object(int id)
	//	{
	//		Id = id;
	//		valueType = RunTimeDataType._OBJECT;



	//	}

	//	internal StackSlot memSlot_;
	...
	//	public override SLOT getSlot(RunTimeScope scope, StackFrame frame)
	//	{
	//		return memSlot_;
	//	}

	//	public override SLOT getSlotForAssign(RunTimeScope scope, StackFrame frame)
	//	{
	//		return memSlot_;
	//	}

	//	public override RunTimeValueBase getValue(RunTimeScope scope, StackFrame frame)
	//	{
	//		return memSlot_.getValue();
	//	}
	...
	//	public static MemRegister_Object LoadRegister(BinaryReader reader, CSWCSerizlizer serizlizer, IDictionary<int, object> serizlized, int key)
	//	{
	//		RunTimeDataType valuetype = reader.ReadInt32();
	//		int id = reader.ReadInt32();

	//		MemRegister_Object register = new MemRegister_Object(id);
	//		serizlized.Add(key, register);
