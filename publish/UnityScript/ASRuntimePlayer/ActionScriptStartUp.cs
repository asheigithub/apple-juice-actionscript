...
public class ActionScriptStartUp : MonoBehaviour {
	...
	IEnumerator Start()
	{
		...
		progress = GameObject.Find("Canvas/Slider").GetComponent<UnityEngine.UI.Slider>();
		progressValue = GameObject.Find("Canvas/Slider/Value").GetComponent<UnityEngine.UI.Text>();
