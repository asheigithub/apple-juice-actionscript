                                ...
                                if (data.Count == 2)
                                {
                                    ...
                                    else
                                    {
										...
										else if (operatorCode == "*")
										{
											...
											if (builder.bin.operatorOverrides.getOperatorFunction(OverrideableOperator.mulit,
												function.signature.parameters[0].type,
												function.signature.parameters[1].type
												) == null
												)
											{
												builder.bin.operatorOverrides.AddOperatorFunction(OverrideableOperator.mulit, function);
											}
											else
											{
												throw new BuildException(as3function.token.line, as3function.token.ptr, as3function.token.sourceFile,
										...
										else if (operatorCode == "/")
										{
											...
											if (builder.bin.operatorOverrides.getOperatorFunction(OverrideableOperator.div,
												function.signature.parameters[0].type,
												function.signature.parameters[1].type
												) == null
												)
											{
												builder.bin.operatorOverrides.AddOperatorFunction(OverrideableOperator.div, function);
											}
											else
											{
												throw new BuildException(as3function.token.line, as3function.token.ptr, as3function.token.sourceFile,
										...
										else if (operatorCode == "%")
										{
											...
											if (builder.bin.operatorOverrides.getOperatorFunction(OverrideableOperator.mod,
												function.signature.parameters[0].type,
												function.signature.parameters[1].type
												) == null
												)
											{
												builder.bin.operatorOverrides.AddOperatorFunction(OverrideableOperator.mod, function);
											}
											else
											{
												throw new BuildException(as3function.token.line, as3function.token.ptr, as3function.token.sourceFile,
										...
										else if (operatorCode == "|")
										{
											...
											if (builder.bin.operatorOverrides.getOperatorFunction(OverrideableOperator.bitOr,
												function.signature.parameters[0].type,
												function.signature.parameters[1].type
												) == null
												)
											{
												builder.bin.operatorOverrides.AddOperatorFunction(OverrideableOperator.bitOr, function);
											}
											else
											{
												throw new BuildException(as3function.token.line, as3function.token.ptr, as3function.token.sourceFile,
